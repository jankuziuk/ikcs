...
<div class="wrap" data-ng-app="ikcs">
    <div data-ng-controller="ikcsAddEditSection">
                                            ...
                                            <div class="ikcs_body" data-ng-show="item.options.open == 1">
                                                ...
                                                <div class="form-wrapper">
                                                    ...
                                                    <div class="repeater" data-ng-if="item.type == 'repeater_object'">
                                                        ...
                                                        <div class="ikcs_repeater_items" data-ng-if="ikcsAdd.item.repeater_fields.length > 0" ui-sortable="sortableOptions" ng-model="ikcsAdd.item.repeater_fields">
